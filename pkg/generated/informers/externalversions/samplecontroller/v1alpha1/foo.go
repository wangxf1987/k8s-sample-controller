...
import (
	...
	samplecontrollerv1alpha1 "k8s.io/k8s-sample-controller/pkg/apis/samplecontroller/v1alpha1"
	versioned "k8s.io/k8s-sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "k8s.io/k8s-sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/k8s-sample-controller/pkg/generated/listers/samplecontroller/v1alpha1"
)
